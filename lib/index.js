...
var TornadoComponent = /** @class */ (function (_super) {
    ...
    TornadoComponent.prototype.deploy = function (inputs) {
        return __awaiter(this, void 0, void 0, function () {
            var frameworkInputs, _a, Detail, formatStr, bootstrapPath, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!(frameworkInputs.Properties.Detail.Function.Runtime === 'python3.7')) return [3 /*break*/, 4];
                        frameworkInputs.Properties.Detail.Function.Runtime = 'custom';
                        _a = inputs.Properties.Detail, Detail = _a === void 0 ? {} : _a;
                        formatStr = {
                            port: bootstrap_1.DEFAULTPORT,
                    ...
                    case 4:
                        ...
                        _d.label = 5;
                    case 5: return [4 /*yield*/, _super.prototype.deploy.call(this, frameworkInputs)];
